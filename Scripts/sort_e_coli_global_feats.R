...
e_coli <- readRDS("./feb_data/e_coli_all_feats.rds")
e_coli_df <- e_coli$df
...
e_coli_global_train <- e_coli_global[e_coli_global$Info_PepID %in% unique_id_train_e_coli, ]
e_coli_global_test <- e_coli_global[e_coli_global$Info_PepID %in% unique_id_test_e_coli, ]
