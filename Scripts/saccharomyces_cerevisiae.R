...
orgID <- 4932 # Saccharomyces cerevisiae - Species 
# orgID <- 4930 # Saccharomyces - Genus
# orgID <- 4893 # Saccharomycetaceae - Family 
# orgID <- 4892 # Saccharomycetales - Order
# orgID <- 4891 # Saccharomycetes - Class
# orgID <- 147537 # Saccharomycotina - Subphylum
# orgID <- 716545 # Saccharomyceta - Clade
# orgID <- 4890 # Ascomycota - Phylum
# orgID <- 451864 # Dikarya - Subkingdom
# orgID <- 4751 # Fungi - Kingdom


savefile <- "./jan_data/plasmodium_laverania_data.rds"
...
peptides.list <- epitopes %>%
  ...
  calc_features(local.features = c("Entropy","MolWeight", "AAtypes", "Atoms",   # <--- local features are calculated for the 15-AA windows and added to peptides.list$df
                ...
                ncpus = ncpus) %>%
  save_peptide_list("./jan_data/plasmodium_laverania")
